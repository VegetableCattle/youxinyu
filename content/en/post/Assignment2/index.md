...
subtitle: The goal of this assignment is to implement kNN algorithm by using Jupyter notebook and [IRIS dataset](https://archive.ics.uci.edu/ml/datasets/Iris ).[Git](https://github.com/VegetableCattle/youxinyu/tree/master/static/files/li_02.ipynb).[Download file](files/li_02.ipynb)
